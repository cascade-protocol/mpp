			...
			items: [
				{
					...
					items: [
						...
						{ text: ".fromHeaders", link: "/sdk/typescript/core/Challenge.fromHeaders" },
						{ text: ".fromResponse", link: "/sdk/typescript/core/Challenge.fromResponse" },
						{ text: ".serialize", link: "/sdk/typescript/core/Challenge.serialize" },
						{ text: ".verify", link: "/sdk/typescript/core/Challenge.verify" },
					],
				},
				{
					text: "Credential",
					collapsed: true,
					items: [
						{ text: ".deserialize", link: "/sdk/typescript/core/Credential.deserialize" },
						{ text: ".from", link: "/sdk/typescript/core/Credential.from" },
						{ text: ".fromRequest", link: "/sdk/typescript/core/Credential.fromRequest" },
						{ text: ".serialize", link: "/sdk/typescript/core/Credential.serialize" },
					],
				},
				{
					text: "Receipt",
					collapsed: true,
					items: [
						{ text: ".deserialize", link: "/sdk/typescript/core/Receipt.deserialize" },
						{ text: ".from", link: "/sdk/typescript/core/Receipt.from" },
						{ text: ".fromResponse", link: "/sdk/typescript/core/Receipt.fromResponse" },
						{ text: ".serialize", link: "/sdk/typescript/core/Receipt.serialize" },
					],
				},
				{
					text: "PaymentRequest",
					collapsed: true,
					items: [
						{ text: ".deserialize", link: "/sdk/typescript/core/PaymentRequest.deserialize" },
						{ text: ".from", link: "/sdk/typescript/core/PaymentRequest.from" },
						{ text: ".serialize", link: "/sdk/typescript/core/PaymentRequest.serialize" },
					],
				},
				{
					text: "BodyDigest",
					collapsed: true,
					items: [
						{ text: ".compute", link: "/sdk/typescript/core/BodyDigest.compute" },
						{ text: ".verify", link: "/sdk/typescript/core/BodyDigest.verify" },
					],
				},
